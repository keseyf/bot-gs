...
const cooldownSet = new Set(); // Bloqueio de flood
...
- Ou realize a compra com pagamento via PIX.`, {
            reply_markup: new grammy_1.InlineKeyboard().text("💸 Adicionar Saldo", "chooseRechargeType")
        });
        return;
    }
...
Logo um administrador irá entrar em contato para enviar-lhe o produto.`, {
    ...
    try {
        await utils_1.app.api.sendMessage(sellerId, `✅ Compra de saldo concluída.
